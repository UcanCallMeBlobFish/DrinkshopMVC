...
{
    public class FakeDrinksRepository : IDrinkRepository
    {
            ...
            return new List<Drink>
    {
        new Drink
        {
            ...
            ImageUrl = "https://s3.envato.com/files/253416235/red%20wine-2.jpg",
            InStock = true,
            IsPreferredDrink = true,
            ImageThumbnailUrl = "https://s3.envato.com/files/253416235/red%20wine-2.jpg"
        },
        new Drink
        {
            Name = "Rum & Coke",
